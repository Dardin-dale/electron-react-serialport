...
/* harmony import */ var _device_DeviceManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./device/DeviceManager */ "./src/device/DeviceManager.js");
...
function (_React$Component) {
  ...
  function Home(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getPods", function () {
      ...
      _this.deviceManager.getPods().then(function (pods) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onClick", function () {
      if (_this.state.pod.sn && _this.state.desired_oem && _this.state.licenses.length > 0) {
        _this.podManager.updatePod(_this.state.pod, _this.state.desired_oem, _this.state.licenses).then(function (update) {
      ...
      } else if (!_this.state.desired_oem) {
        alert("Not possible?");
      } else if (_this.state.licenses.length === 0) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "home",
        style: styles.home
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("text", null, "Hello World!"));
    }
  }]);
...
*/
var SerialPort = __webpack_require__(/*! serialport */ "serialport");

var MyDevice = __webpack_require__(/*! ./my_device */ "./src/device/my_device.js");
...
window.onload = function () {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Home__WEBPACK_IMPORTED_MODULE_2__["default"], null), document.getElementById('app'));
};
